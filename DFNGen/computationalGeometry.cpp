...
double *rotationMatrix_2(double *normalA, double *normalB) {
    //***************************************************
...
bool checkBoundingBox(Poly &poly1, Poly &poly2) {
    if (poly1.boundingBox[1] < poly2.boundingBox[0]) {
        return false;
    }
    
    if (poly1.boundingBox[0] > poly2.boundingBox[1]) {
        return false;
    }
    
    if (poly1.boundingBox[3] < poly2.boundingBox[2]) {
        return false;
    }
    
    if (poly1.boundingBox[2] > poly2.boundingBox[3]) {
        return false;
    }
    
    if (poly1.boundingBox[5] < poly2.boundingBox[4]) {
        return false;
    }
    
    if (poly1.boundingBox[4] > poly2.boundingBox[5]) {
        return false;
    }
